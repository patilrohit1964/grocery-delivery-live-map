      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="shadow-md rounded-2xl p-4">
          ...
          <div className=" w-ful my-4">
            ...
            {/* div 4 */}
            <div className="flex flex-col md:flex-row gap-2 items-center my-4">
              <input
                className="w-full rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 border border-gray-300 transition-all"
                placeholder="City"
              />
            ...
            <div className="flex flex-col md:flex-row mb-4">
              <input
                className="md:flex-1 gap-2 items-center rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 border border-gray-300 transition-all mb-2 md:mb-0"
                placeholder="Search city or area"
              />
              <motion.button
                whileTap={{ scale: 0.8 }}
                className="bg-green-600 hover:bg-green-700 cursor-pointer text-white px-6 py-2 rounded-lg ml-1"
              >
                Search
              </motion.button>
            </div>
        ...
        {/* checkout div */}
        <div className="shadow-md rounded-2xl p-4 w-full max-w-full h-96">
          ...
          <div className="flex flex-col">
            <motion.button
              whileTap={{ scale: 0.8 }}
              className={`w-full mt-4 py-3 px-4 rounded-lg font-medium transition-all cursor-pointer border-2 border-gray-600 hover:bg-green-100 flex items-center gap-2 ${select === 1 ? "bg-green-100 border-green-600" : ""}`}
              onClick={() => setSelect(1)}
            >
            ...
            <motion.button
              whileTap={{ scale: 0.8 }}
              className={`w-full mt-4 py-3 px-4 rounded-lg font-medium transition-all cursor-pointer border-2 border-gray-600 hover:bg-green-100 flex items-center gap-2 ${select === 2 ? "bg-green-100 border-green-600" : ""}`}
              onClick={() => setSelect(2)}
            >
